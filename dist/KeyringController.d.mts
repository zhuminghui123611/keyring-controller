 ...
 */
export type ExportableKeyEncryptor<EncryptionKey = unknown> = GenericEncryptor & {
    /**
     ...
     */
    encryptWithKey: (key: EncryptionKey, object: Json) => Promise<encryptorUtils.EncryptionResult>;
    /**
     ...
     * @returns The decrypted object.
     */
    decryptWithKey: (key: EncryptionKey, encryptedString: string) => Promise<unknown>;
    /**
 ...
 */
export declare function keyringBuilderFactory(KeyringConstructor: KeyringClass): {
    (): import("@metamask/keyring-utils").Keyring;
    type: string;
};
...
export declare class KeyringController extends BaseController<typeof name, KeyringControllerState, KeyringControllerMessenger> {
     ...
     * @returns Promise resolving to the added account address
     */
    addNewAccountForKeyring(keyring: EthKeyring, accountCount?: number): Promise<Hex>;
    /**
     ...
     */
    addNewKeyring(type: KeyringTypes | string, opts?: unknown): Promise<KeyringMetadata>;
    /**
     ...
     */
    signTransaction(transaction: TypedTransaction, from: string, opts?: Record<string, unknown>): Promise<TypedTxData>;
    /**
     ...
     */
    exportEncryptionKey(): Promise<string>;
    /**
     ...
     */
    withKeyring<SelectedKeyring extends EthKeyring = EthKeyring, CallbackResult = void>(selector: KeyringSelector, operation: ({ keyring, metadata, }: {
...
//# sourceMappingURL=KeyringController.d.mts.map